...
<div id = "delete" name = "delete">
    <p id = "p">which msg you want to delete?</p>
    <form method="POST" >
    <input type = "number" min = "1" name = "num" >
    <p><input type="submit" value="刪除留言"> <input type ="button" value = "回留言板" onclick = "javascript:location.href='board_admin.php'">
</form>
</div>
...
<?php
    ...
    $sth->execute(array("the msg has been deleted",$_POST['num']));
    if ($_POST['num'] != ""){
        $url = "board_admin.php";
